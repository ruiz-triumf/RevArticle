...
\title{Recoil separators for radiative capture}
...
\input{SepTheory}         % Theory of electromagnetic separators 

\input{GasTargets}        % Gas Targets 

\input{AncDetectors}       % Ancillary detectors and methods 

\input{EarlyStableBeam}    % Early work at stable beam facilities

\input{RIBF}               % Recoil separators at radioactive ion beam facilities

%\input{TechHighlights}     % Highlights of technical performance

\input{SciHighlights}      % Scientific highlights

\input{Outlook}           % Outlook and guidance for future separators
